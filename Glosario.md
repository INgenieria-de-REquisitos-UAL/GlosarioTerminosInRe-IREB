...
Date: 05 de Junio de 2021
  ...
  |2. In software development: A development approach which builds a product incrementally by dividing work into iterations of fixed  duration (timeboxes).  | Ágil  | En desarrollo de software una aproximación al desarrollo que construye el producto en incrementos dividiendo el trabajo en iteraciones de duración fija (intervalos de tiempo)  |  
  ...
  |Requirements baseline  | A  baseline for a set of  requirements.  | Línea base de requisitos  |   |  
  ...
  |Role  | A part played by a person in a given context.  |  
  ...
  |Scrum  | A popular  process framework for  agile development of a  system  | Scrum  |   |  
  ...
  |Service  | The provision of some  functionality to a human or a  system by a  |  
  ...
  |Specification by example  | A  technique that specifies test cases and  requirements for a  system  |  
  |by providing examples of how the system should behave.  | Especificación por ejemplos  |   |  
  |Specification  |  
  ...
  |Spike  | In agile development: A task aimed at gaining insight or gathering information, rather than at producing a  product  increment.  | Spike (profundizar)  |   |  
  |Sprint  | An  iteration in  agile development, particularly when using  Scrum.  | Sprint - Iteración  |   |  
  |Sprint backlog  | A set of  product backlog items that have been selected to be implemented in the current  sprint.  | Pila del sprint  |   |  
  ...
  |Stakeholder requirement  | A  requirement expressing a  stakeholder desire or need.  |  
  |Note: Stakeholder requirements are typically written by stakeholders and  |  
  |express their desires and needs from their perspective  | Requisito de los interesados  |   |  
  ...
  |State machine diagram  | A diagrammatic representation of a  state machine.  | Diagrama de máquina de estados  |   |  
  |State-transition  |  
  |diagram  |  
  ...
  |Story   | User story  | Historia (de usuario  |   |  
  |Story map  | A two-dimensional arrangement of  user stories.  |  
  |Note: A story map helps understand the  functionality of a  system, identify  |  
  |gaps and plan releases.  | Gráfico de historias de usuario  |   |  
  |Structured  |  
  |Analysis  |  
  ...
  |Task  | A coherent chunk of work to be done.  | Tarea  |   |  
  |Technique  | A documented set of coherent actions for accomplishing a  task or  |  
  |achieving an objective.  | Técnica  |   |  
  |Theme  | In agile development: A collection of related  user stories.  | Tema  |   |  
  |Timebox  | A fixed, non-extendable amount of time for completing a set of  tasks.  | Intervalo de tiempo  |   |  
  |Tool (in software  |  
  |engineering)  |  
  ...
  |Understandability  | The degree to which an  item is comprehensible to its intended users.  | Entendibilidad  |   |  
  |Unambiguity (of  |  
  |requirements)  |  
  ...
  |Use case model  | A  model consisting of a set of  use cases, typically together with a  use  |  
  |case diagram.  | Modelo de casos de uso  |   |  
  ...
  |Note: User requirements are typically about what a system should do for  |  
  |certain users and how they can interact with the system. User requirements are  |  
  |a subset of  stakeholder requirements.  | Requisito de usuario  |   |  
  |User story  | A description of a need from a  user’s perspective together with the  |  
  |expected benefit when this need is satisfied.  |  
  |Notes:  |  
  |1. User stories are typically written in  natural language using a  phrase  |  
  |template and are accompanied by  acceptance criteria.  |  
  |2. In  agile development, user stories are the main means for  |  
  |communicating needs between a  product owner and the development  |  
  |team.  | Historia de usuario  |   |  
  |Validation  (of  |  
  ...
  |Variability  | 1. The degree to which a  system can be changed or customized.  |  
  |2. In product lines: The  features that can differ among the members of  |  
  |the  product line.  | Variabilidad  |   |  
  |Variant  | One of the possible forms that an  item (e.g., a  requirement) may have.  | Variante  |   |  
  |Variation point  | A point in a  product line where an element of the product line (typically a variable or a  feature) can be chosen from a set of  variants.  | Punto de variación  |   |  
  |Verifiability (of  |  
  |requirements)  |  
  ...
  |Vision  | A conceptual imagination of a future  system or  product, describing its key characteristics and how it will create value for its  users.  | Vision  |   |  
  ...
  |Wireframe  | A  review in which the author of a  work product leads the reviewers systematically through the work product and the reviewers ask questions and make comments about possible issues  |   |   |  
  |Work product  | A recorded, intermediate or final result generated in a work  process.  | Producto generado  |   |  
  |  |   |   |   |  
  |
